...
const TicketLookup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (fetchedBooking.passengerEmail.toLowerCase() === passengerEmail.toLowerCase()) {
                setBooking(fetchedBooking);
            } else {
                setError("No matching booking found. Please check your details and try again.");
            }
        } catch (error) {
    ...
    return (
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-primary">Look up Ticket</button>
            </form>
