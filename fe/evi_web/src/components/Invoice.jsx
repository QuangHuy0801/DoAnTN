        ...
        <div style={{ marginBottom: '50px', marginTop: '80px' }}>
            <div className="container" id="invoice">
                <div style={{ display: 'flex' }}>
                    <a href="/home" className="btn btn-primary" style={{ marginRight: '30px' }}>Back to Home</a>
                ...
                <div className="col-md-3">
                    ...
                    <div className="col-md-3">
                        <p id="details">
                            ...
                            <strong>Issued: </strong>{new Date(booking.bookingDate).toLocaleDateString()}<br />
                        </p>
                    </div>
                </div>
    ...
    <div className="col-md-12">
        <table className="table margin-top-20">
            ...
            <tbody>
                ...
                <tr>
                    <td>Schedule</td>
                    <td>{new Date(booking.schedule.departureTime).toLocaleString()} - {new Date(booking.schedule.arrivalTime).toLocaleString()}</td>
                </tr>
                <tr>
                    <td>Vehicle</td>
                    <td>{booking.schedule.vehicle.vehicleNumber} ({booking.schedule.vehicle.vehicleType})</td>
                </tr>
                <tr>
                    <td>Distance</td>
                ...
                <tr>
                    <td>Seats Booked</td>
                    <td>{booking.bookingDetails.map(detail => detail.seat.seatNumber).join(', ')}</td>
                </tr>
            </tbody>
        </table>
    </div>
...
<div className="col-md-4 col-md-offset-8">
    <table className="table" id="totals">
        <tbody>
            ...
            <tr>
                <th>Total Due</th>
                <td>{(booking.schedule.price * booking.bookingDetails.length).toLocaleString('en-US')} VNĐ</td>
            </tr>
        </tbody>
    </table>
             ...
             <div className="row">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <ul id="footer">
                            <li><span>www.eviapp.com</span></li>
