...
import { getAllSchedule, addSchedule, updateSchedule, deleteSchedule } from '../services/SchedulesService';
                ...
                <tbody>
                    {schedules.map((schedule) => (
                        <tr key={schedule.scheduleId}>
                            ...
                            <td>
                                <Button variant="warning" size="sm" className="me-2" onClick={() => handleShowModal(schedule)}>
                                    <FontAwesomeIcon icon={faEdit} /> Edit
                                </Button>
                                <Button variant="danger" size="sm" onClick={() => handleDelete(schedule.scheduleId)}>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group as={Row}>
                            ...
                            <Col sm={9}>
                                <Form.Control as="select" name="routeId" value={formData.routeId} onChange={handleInputChange}>
                        ...
                        <Form.Group as={Row}>
                            <Form.Label column sm={3}>Departure Time</Form.Label>
                            <Col sm={9}>
                                <DatePicker
                        ...
                        <Form.Group as={Row}>
                            <Form.Label column sm={3}>Arrival Time</Form.Label>
                            <Col sm={9}>
                                <DatePicker
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm={9}>
                                <Form.Control as="select" name="vehicleId" value={formData.vehicleId} onChange={handleInputChange}>
