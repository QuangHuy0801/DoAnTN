...
import { forgotNewPassAdmin, forgotPasswordAdmin, signInAdmin } from '../services/UserService';
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-12 col-lg-10">
                            <div className="wrap d-md-flex">
                                <div className="img" style={{ backgroundImage: 'url(/img/signin/signin_dashboard.png)' }}></div>
