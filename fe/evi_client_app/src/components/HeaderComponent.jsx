          ...
          <div className="col-lg-6 col-md-6">
            <nav className="header__menu mobile-menu">
              <ul>
                ...
                <li className={isActiveLink("/schedule")}>
                  <a href="/schedule">Lịch trình</a>
                </li>
                <li className={isActiveLink("/ticketLookup")}>
                  <a href="/ticketLookup">Tra cứu vé</a>
                </li>
                <li className={isActiveLink("/myhistory")}>
                  <a href="/myhistory">Lịch sử</a>
                </li>
