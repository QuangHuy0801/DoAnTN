...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate(
      `/schedule?origin=${originValue}&destination=${destinationValue}&travelDate=${travelDateValue}`
    );
  };
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div
              ...
              style={{ backgroundImage: `url(img/home/backgroud_top.png)` }}
            ></div>
          </div>
        </div>
      </section>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="trip-type-toggle mb-3 d-flex align-items-center">
                    <a href="#" className="card-title ml-auto">
                      Hướng dẫn mua vé
                    </a>
                  </div>
            ...
            <div className="col-lg-8">
              <div className="instagram__pic">
                <div
                  ...
                  style={{ backgroundImage: "url(img/home/1.jpg)" }}
                ></div>
                <div
                  className="instagram__pic__item set-bg"
                  style={{ backgroundImage: "url(img/home/2.jpg)" }}
                ></div>
                <div
                  className="instagram__pic__item set-bg"
                  style={{ backgroundImage: "url(img/home/3.jpg)" }}
                ></div>
              </div>
            </div>
            <div className="col-lg-4">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                <div
                  ...
                  style={{ backgroundImage: "url(img/home/momo.png)" }}
                ></div>
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.png" alt="" /> 9/6/2024{" "}
                  </span>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                <div
                  className="blog__item__pic set-bg"
                  style={{ backgroundImage: "url(img/home/zalopay.png)" }}
                ></div>
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.png" alt="" /> 5/6/2024
                  </span>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                <div
                  className="blog__item__pic set-bg"
                  style={{ backgroundImage: "url(img/home/vnpay.png)" }}
                ></div>
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.png" alt="" /> 2/6/2024
                  </span>
