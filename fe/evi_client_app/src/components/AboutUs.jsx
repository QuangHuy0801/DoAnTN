          ...
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="about__item">
                ...
                <p>
                  Evibus cam kết cung cấp các giải pháp vận chuyển hiệu quả và
                  thân thiện với môi trường. Chúng tôi tập trung vào việc cung
                  cấp dịch vụ chất lượng cao với cam kết bảo vệ môi trường.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="about__item">
                ...
                <p>
                  Chúng tôi cung cấp một loạt các dịch vụ vận chuyển bao gồm đặt
                  xe buýt, theo dõi thời gian thực và hỗ trợ khách hàng để đảm
                  bảo trải nghiệm đi lại suôn sẻ và đáng tin cậy.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="about__item">
                ...
                <p>
                  Với sự chú trọng đến sự an toàn, đúng giờ và sự hài lòng của
                  khách hàng, Evibus nổi bật với dịch vụ chất lượng và giải pháp
                  sáng tạo trong ngành vận tải.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6 p-0">
              <div className="testimonial__text">
                ...
                <p>
                  “Evibus đã làm thay đổi hành trình hàng ngày của tôi với dịch
                  vụ đáng tin cậy và thoải mái. Rất đáng để thử!”
                </p>
            ...
            <div className="col-lg-6 p-0">
              <div
                ...
                data-setbg="img/about/testimonial-pic-evibus.jpg"
              ></div>
            </div>
          </div>
        </div>
