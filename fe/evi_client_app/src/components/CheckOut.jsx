  ...
  if (!bookingData) {
    return (
      <div className="alert alert-danger">
        No booking data available. Please go back and book again.
      </div>
    );
  }
      ...
      try {
        ...
        if (paymentCode === "COD") {
          ...
          intervalId = setInterval(
            () => kiemTraTrangThaiThanhToan(bookingData.bookingId),
            5000
          );
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <TripInfo
            ...
            price={price}
            selectedSeats={bookingDetails.map(
              (detail) => detail.seat.seatNumber
            )}
